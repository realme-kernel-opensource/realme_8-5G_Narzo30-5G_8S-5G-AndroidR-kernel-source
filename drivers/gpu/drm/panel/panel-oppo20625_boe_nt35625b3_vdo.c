...
//gamma1 start
	...
	lcm_dcs_write_seq_static(ctx, 0xB0,0x00,0x0D,0x00,0x19,0x00,0x34,0x00,0x48,0x00,0x5C,0x00,0x6E,0x00,0x7E,0x00,0x8C);
	lcm_dcs_write_seq_static(ctx, 0xB1,0x00,0x9A,0x00,0xC7,0x00,0xEC,0x01,0x26,0x01,0x54,0x01,0x9E,0x01,0xD9,0x01,0xDB);
	lcm_dcs_write_seq_static(ctx, 0xB2,0x02,0x13,0x02,0x54,0x02,0x7E,0x02,0xB6,0x02,0xE0,0x03,0x13,0x03,0x24,0x03,0x38);
	lcm_dcs_write_seq_static(ctx, 0xB3,0x03,0x4C,0x03,0x61,0x03,0x79,0x03,0x8E,0x03,0xA8,0x03,0x84);

	lcm_dcs_write_seq_static(ctx, 0xB4,0x00,0x0D,0x00,0x19,0x00,0x34,0x00,0x48,0x00,0x5C,0x00,0x6E,0x00,0x7E,0x00,0x8C);
	lcm_dcs_write_seq_static(ctx, 0xB5,0x00,0x9A,0x00,0xC7,0x00,0xEC,0x01,0x26,0x01,0x54,0x01,0x9E,0x01,0xD9,0x01,0xDB);
	lcm_dcs_write_seq_static(ctx, 0xB6,0x02,0x13,0x02,0x54,0x02,0x7E,0x02,0xB6,0x02,0xE0,0x03,0x13,0x03,0x24,0x03,0x38);
	lcm_dcs_write_seq_static(ctx, 0xB7,0x03,0x4C,0x03,0x61,0x03,0x79,0x03,0x8E,0x03,0xA8,0x03,0x84);

	lcm_dcs_write_seq_static(ctx, 0xB8,0x00,0x0D,0x00,0x19,0x00,0x34,0x00,0x48,0x00,0x5C,0x00,0x6E,0x00,0x7E,0x00,0x8C);
	lcm_dcs_write_seq_static(ctx, 0xB9,0x00,0x9A,0x00,0xC7,0x00,0xEC,0x01,0x26,0x01,0x54,0x01,0x9E,0x01,0xD9,0x01,0xDB);
	lcm_dcs_write_seq_static(ctx, 0xBA,0x02,0x13,0x02,0x54,0x02,0x7E,0x02,0xB6,0x02,0xE0,0x03,0x13,0x03,0x24,0x03,0x38);
	lcm_dcs_write_seq_static(ctx, 0xBB,0x03,0x4C,0x03,0x61,0x03,0x79,0x03,0x8E,0x03,0xA8,0x03,0x84);

	lcm_dcs_write_seq_static(ctx, 0xFF, 0x21);
	lcm_dcs_write_seq_static(ctx, 0xFB, 0x01);

	lcm_dcs_write_seq_static(ctx, 0xB0,0x00,0x05,0x00,0x11,0x00,0x2C,0x00,0x40,0x00,0x54,0x00,0x66,0x00,0x76,0x00,0x84);
	lcm_dcs_write_seq_static(ctx, 0xB1,0x00,0x92,0x00,0xBF,0x00,0xE4,0x01,0x1E,0x01,0x4C,0x01,0x96,0x01,0xD1,0x01,0xD3);
	lcm_dcs_write_seq_static(ctx, 0xB2,0x02,0x0B,0x02,0x4C,0x02,0x76,0x02,0xAE,0x02,0xD8,0x03,0x0B,0x03,0x1C,0x03,0x30);
	lcm_dcs_write_seq_static(ctx, 0xB3,0x03,0x44,0x03,0x59,0x03,0x71,0x03,0x86,0x03,0xA0,0x03,0xCB);

	lcm_dcs_write_seq_static(ctx, 0xB4,0x00,0x05,0x00,0x11,0x00,0x2C,0x00,0x40,0x00,0x54,0x00,0x66,0x00,0x76,0x00,0x84);
	lcm_dcs_write_seq_static(ctx, 0xB5,0x00,0x92,0x00,0xBF,0x00,0xE4,0x01,0x1E,0x01,0x4C,0x01,0x96,0x01,0xD1,0x01,0xD3);
	lcm_dcs_write_seq_static(ctx, 0xB6,0x02,0x0B,0x02,0x4C,0x02,0x76,0x02,0xAE,0x02,0xD8,0x03,0x0B,0x03,0x1C,0x03,0x30);
	lcm_dcs_write_seq_static(ctx, 0xB7,0x03,0x44,0x03,0x59,0x03,0x71,0x03,0x86,0x03,0xA0,0x03,0xCB);

	lcm_dcs_write_seq_static(ctx, 0xB8,0x00,0x05,0x00,0x11,0x00,0x2C,0x00,0x40,0x00,0x54,0x00,0x66,0x00,0x76,0x00,0x84);
	lcm_dcs_write_seq_static(ctx, 0xB9,0x00,0x92,0x00,0xBF,0x00,0xE4,0x01,0x1E,0x01,0x4C,0x01,0x96,0x01,0xD1,0x01,0xD3);
	lcm_dcs_write_seq_static(ctx, 0xBA,0x02,0x0B,0x02,0x4C,0x02,0x76,0x02,0xAE,0x02,0xD8,0x03,0x0B,0x03,0x1C,0x03,0x30);
	lcm_dcs_write_seq_static(ctx, 0xBB,0x03,0x44,0x03,0x59,0x03,0x71,0x03,0x86,0x03,0xA0,0x03,0xCB);
//end
